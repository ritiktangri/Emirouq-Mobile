...
export default function DistributionChart({ chartId }: any) {
  ...
  }, [chartId, chartReport?.[state?.route], loadingScreens]);
  ...
  const series = useMemo(
    ...
    [chartReport?.[state?.route]?.length]
  );
  ...
  }, [chartInstance, dataAxis, chartReport?.[state?.route]?.length, loadingScreens]);
