...
const Loading = ({ id }: any) => {
  ...
  const renderItem = ({ item }: any) => {
    ...
    switch (item.type) {
      case 'recent-trades':
        return (
          <View className={cn('my-2 flex-1 rounded-lg  p-3 dark:bg-dashboard_card')}>
      ...
      case 'cumulative-pnl':
        return (
          <View className={cn('my-2 h-[240px] rounded-lg p-2 dark:bg-dashboard_card')}>
            <View className=" flex-row items-center ">
              {[1, 2]?.map((i) => {
                return (
                  <View
                    key={i}
                    className={cn(' flex-1  gap-4 rounded-lg p-4 dark:bg-dashboard_card')}>
                    <Animated.View
                      style={[
                        {
                          width: 80,
      ...
      case 'filter':
        return (
          <View className={cn(' rounded-lg p-3 dark:bg-dashboard_card')}>
