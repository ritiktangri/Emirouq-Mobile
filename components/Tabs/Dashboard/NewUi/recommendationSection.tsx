...
export default function Marketplace() {
  const renderProductCard = ({ item }: any) => (
    <TouchableOpacity className=" mr-3 w-56 overflow-hidden rounded-2xl border border-gray-300 bg-white  p-3">
  ...
  return sections.map((section) => renderHorizontalSection(section));
}
